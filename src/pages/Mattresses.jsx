...
const Mattresses = () => {
  return (
    <>
      <BreadCrumb pageName='Mattresses' />
      <div className="container my-5">
        <h1 className="mb-4 font-1">Mattresses</h1>
        <p>Discover WoodMart's innovative bedding technology in our comfortable and stylish mattress models for an unparalleled sleep experience. Click now to explore the latest bed options and elevate your sleep quality.</p>
