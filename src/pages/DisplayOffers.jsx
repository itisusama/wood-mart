...
const DisplayOffers = () => {
  return (
    <>
      <BreadCrumb pageName='Display Offers' />
      <div className="container my-5">
        <h1 className="mb-4 font-1">Display Offers</h1>
        <p className='font-1'>Your products will be delivered from the Enfield or Lewisham showroom display.
        </p>
